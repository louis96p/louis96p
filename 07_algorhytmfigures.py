...
CoeffName = ['revenuePerShare_x', 'netIncomePerShare_x','operatingCashFlowPerShare_x', 'freeCashFlowPerShare_x',
'bookValuePerShare_x', 'shareholdersEquityPerShare_x', 'peRatio_x','priceToSalesRatio_x', 'pbRatio_x', 'evToSales_x','enterpriseValueOverEBITDA_x', 'debtToEquity_x', 'debtToAssets_x',
'currentRatio_x', 'payoutRatio_x', 'roic_x', 'workingCapital_x',
'investedCapital_x', 'roe_x', 'dcf_x', 'netIncomePerShare_S',
'operatingCashFlowPerShare_S', 'peRatio_S', 'pbRatio_S', 'evToSales_S',
'enterpriseValueOverEBITDA_S', 'debtToEquity_S', 'workingCapital_S',
'debtToAssets_S', 'currentRatio_S', 'payoutRatio_S', 'roe_S', 'roic_S',
'investedCapital_S', 'price']
...
for i in Sector:
    ...
    CKPI = CompanyKPI.loc[CompanyKPI['sector'] == i ].drop(columns=['symbol','date_new','period','sector','StockType'])
